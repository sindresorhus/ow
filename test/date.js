...
test('date.before', t => {
	...
	t.throws(() => {
		ow(new Date('2017-11-25T12:00:00Z'), ow.date.before(new Date('2017-11-25T12:00:00Z')));
	}, {
		message: 'Expected date 2017-11-25T12:00:00.000Z to be before 2017-11-25T12:00:00.000Z'
	});

	t.throws(() => {
		ow(new Date('2017-11-25T12:00:00Z'), 'foo', ow.date.before(new Date('2017-11-25T12:00:00Z')));
	}, {
...
test('date.after', t => {
	...
	t.throws(() => {
		ow(new Date('2017-11-26T12:00:00Z'), ow.date.after(new Date('2017-11-26T12:00:00Z')));
	}, {
