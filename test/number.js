...
test('number.greaterThanOrEqual', t => {
	...
	t.throws(() => {
		ow(10, ow.number.greaterThanOrEqual(11));
	}, {
		message: 'Expected number to be greater than or equal to 11, got 10'
	});

	t.throws(() => {
		ow(10, ow.number.greaterThanOrEqual(20));
	}, {
...
test('number.lessThanOrEqual', t => {
	...
	t.throws(() => {
		ow(10, ow.number.lessThanOrEqual(9));
	}, {
		message: 'Expected number to be less than or equal to 9, got 10'
	});

	t.throws(() => {
		ow(10, ow.number.lessThanOrEqual(0));
	}, {
...
test('number.finite', t => {
	...
	t.throws(() => {
		ow(Number.POSITIVE_INFINITY, ow.number.finite);
	}, {
