...
test('string.length', t => {
	...
	t.throws(() => {
		ow('foo', ow.string.length(4));
	}, {
		message: 'Expected string to have length `4`, got `foo`'
	});
	t.throws(() => {
		ow('foo', 'foo', ow.string.length(4));
	}, {
...
test('string.matches', t => {
	...
	t.throws(() => {
		ow('bar', ow.string.matches(/^f.o$/i));
	}, {
...
test('string.startsWith', t => {
	...
	t.throws(() => {
		ow('foo', ow.string.startsWith('oo'));
	}, {
		message: 'Expected string to start with `oo`, got `foo`'
	});
	t.throws(() => {
		ow('foo', ow.string.startsWith('b'));
	}, {
...
test('string.endsWith', t => {
	...
	t.throws(() => {
		ow('foo', ow.string.endsWith('fo'));
	}, {
		message: 'Expected string to end with `fo`, got `foo`'
	});
	t.throws(() => {
		ow('foo', ow.string.endsWith('ar'));
	}, {
...
test('string.date', t => {
	...
	t.throws(() => {
		ow('foo', ow.string.date);
	}, {
		message: 'Expected string to be a date, got `foo`'
	});
	t.throws(() => {
		ow('foo', 'bar', ow.string.date);
	}, {
...
test('string.url', t => {
	...
	t.throws(() => {
		ow('foo', ow.string.url);
	}, {
		message: 'Expected string to be a URL, got `foo`'
	});
	t.throws(() => {
		ow('foo', 'bar', ow.string.url);
	}, {
